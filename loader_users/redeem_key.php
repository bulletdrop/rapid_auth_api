...
$license_key = rn_cryptor_decrypt_rapid_auth($_POST["license_key"], $open_ssl_key);
...
if (!$key_valid)
{
    echo rn_cryptor_encrypt_rapid_auth(json_encode(array("status" => "error", "message" => "Invalid License Key")), $open_ssl_key);
    exit();
}
else
{
